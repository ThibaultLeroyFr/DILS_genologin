...
echo "nMin: 6" >> "$Species1"_"$Species2"_"$constant_or_variable_Ne_through_time"Ne_"$use_the_SFS"SFS_nooutgroup.yaml #this corresponds to the number of individuals considering diploids (so 12 haploid sequences, here the minimum number of individuals in the dataset is 16 haploid)
