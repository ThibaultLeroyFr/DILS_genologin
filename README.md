...
To exclude nodes that lead to jobs stuck forever as running on these nodes (e.g. node129 recently), it is possible to use the function: <br>
...
To allow this to be valid on all the jobs launch by snakemake, this requires to ajust the script used to launch snakemake and the associated json file (see script_lanceur2_DILS.sh & cluster2.json) <br>
